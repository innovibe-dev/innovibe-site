...
const Hero = () => {
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-6 gap-y-10 items-center">
        <div className="">
          <h1 className="text-3xl md:text-5xl/tight lg:text-6xl/tight text-black tracking-normal capitalize leading-normal font-bold max-w-2xl">
            Premium Electric Vehicles & Expert Services          </h1>
          ...
          <div className="flex flex-wrap mt-9 text-center gap-3">
            ...
            <Link href="./contact" className="py-2 px-6 text-primary rounded-md border border-primary text-base hover:border-primary hover:bg-primary hover:text-white transition-all duration-500 font-medium">
              Contact Us
            </Link>
          </div>
        </div>
  ...
  className="max-h-[1000px] max-w-[600px] md:max-w-[800px] mx-auto"
/>
