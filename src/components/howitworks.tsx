  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        {/* Call To Action */}
        <div className="bg-blue-600 text-white rounded-xl mt-16 p-10 text-center max-w-4xl mx-auto">
          <h2 className="text-2xl font-semibold">Ready to Get Started?</h2>
          <p className="mt-3 max-w-2xl mx-auto">
            Join the thousands of satisfied customers who have experienced our
            seamless EV services. Start your journey today!
          </p>

          {/* Buttons */}
          <div className="mt-6 flex justify-center gap-4">
            <Link href="./ev-services" className="no-underline">
              <button className="bg-white text-blue-600 font-medium px-6 py-2 rounded-md hover:bg-gray-100 transition">
                Choose Your Service
              </button>
            </Link>
            <Link href="/contact" className="no-underline">
              <button className="bg-blue-700 text-white font-medium px-6 py-2 rounded-md hover:bg-blue-800 transition">
                Contact Support
              </button>
            </Link>
          </div>
