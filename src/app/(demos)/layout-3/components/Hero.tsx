...
const Hero = () => {
  return (
    <section
      className="relative pt-10 pb-20 bg-gray-200/40 bg-[url(../images/home/bg-3.png)] bg-no-repeat bg-cover"
      id="home"
    >
      <div className="container">
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-6 gap-y-10 items-center">
          ...
          <div className="relative order-1 lg:order-2 flex justify-center -ml-14">
            <Image
              src={iterior}
              className="w-[350px] h-[700px] rounded-xl ml-10"
              alt="image-image"
            />
          </div>
        </div>
